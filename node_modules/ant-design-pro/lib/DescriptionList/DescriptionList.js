...
var styles = {
  ...
  'descriptionListSmall': 'antd-pro-description-list-descriptionListSmall',
  'descriptionListLarge': 'antd-pro-description-list-descriptionListLarge'
};
...
exports.default = function (_ref) {
  ...
  var clsString = (0, _classnames2.default)(styles.descriptionList, styles[layout], className, (_classNames = {}, _defineProperty(_classNames, styles.descriptionListSmall, size === 'small'), _defineProperty(_classNames, styles.descriptionListLarge, size === 'large'), _classNames));
