...
var Pie = (_dec = (0, _bind2.default)(), _dec2 = (0, _debounce2.default)(300), (_class = function (_Component) {
        ...
        hasLegend && _react2.default.createElement(
          ...
          legendData.map(function (item, i) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement('span', { className: styles.dot, style: { backgroundColor: !item.checked ? '#aaa' : item.color } }),
              _react2.default.createElement(
                'span',
  ...
  return Pie;
}(_react.Component), (_applyDecoratedDescriptor(_class.prototype, 'resize', [_dec, _dec2], Object.getOwnPropertyDescriptor(_class.prototype, 'resize'), _class.prototype)), _class));
exports.default = Pie;
