...
var MiniArea = (_temp2 = _class = function (_PureComponent) {
  ...
  function MiniArea() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MiniArea.__proto__ || Object.getPrototypeOf(MiniArea)).call.apply(_ref, [this].concat(args))), _this), _this.handleRef = function (n) {
      _this.node = n;
